...
import Tools13 from "/assets/tools/sql_server.png";
...
export const listProyek = [
  {
    id: 1,
    image: Proyek1,
    title: "Dormitory AstraTech System",
    subtitle: "Help Administrators monitor student activities within the dormitory...",
    fullDescription:"Dormitory Astratech is a web-based system designed to help administrators monitor student activities within the dormitory. With a team of five members, we developed the project from business process design to full implementation, ensuring integration with users for proper analysis.",
    borderColor: "#3B82F6",
    gradient: "linear-gradient(145deg, #3B82F6, #000)",
    url: "https://github.com/zyhni",
    dad: "100",
  },
  {
    id: 2,
