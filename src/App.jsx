        ...
        <div className="hero grid md:grid-cols-2 items-center pt-10 xl:gap-0 gap-6 grid-cols-1">
          <div className="animate__animated animate__fadeInUp animate__delay-3s">
            <div className="flex items-center gap-3 mb-6 bg bg-zinc-800 w-fit p-4 rounded-2xl">
              <img src="./assets/Faiz.png" className="w-10 rounded-md" />
              <q>Just do it or never get it</q>
            </div>
            <h1 className="text-5xl font-bold mb-6">
              <ShinyText text="Hi I'm Faiz Zihni Ammar" disabled={false} speed={3} className='custom-class' />
            </h1>
            <BlurText
              text="I am a passionate application and web developer dedicated to crafting modern, high performance digital experiences through innovative and user friendly solutions."
              delay={150}
              animateBy="words"
              direction="top"
              className=" mb-6"
            ...
            <div className="flex items-center sm:gap-4 gap-2">
              <a 
                href="./assets/Faiz Zihni Ammar_CV.pdf" 
                download="Faiz Zihni Ammar_CV.pdf" 
              ...
              <div className="flex-1 text-left">
                ...
                <div className="flex flex-col sm:flex-row items-center sm:justify-between text-center sm:text-left gap-y-8 sm:gap-y-0 mb-4 w-full">
                  ...
                  <div data-aos="fade-up" data-aos-duration="1000" data-aos-delay="600" data-aos-once="true">
                    <h1 className="text-3xl md:text-4xl mb-1">
                      3.31<span className="text-violet-500">/4.00</span>
                    </h1>
                    <p>GPA</p>
                  </div>
                </div>
        ...
        <div className="kontak mt-32 sm:p-10 p-0" id="contact">
          ...
          <div className="flex flex-col md:flex-row gap-8">
            ...
            <div className="flex-1">
              <form
                action="https://formsubmit.co/faizzihnia@gmail.com"
                method="POST"
